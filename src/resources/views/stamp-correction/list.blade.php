        ...
        <div class="stamp-correction__list">
            ...
            <div class="stamp-correction__item">
                ...
                <div class="stamp-correction__item-actions">
                    <a href="{{ route('attendance.show', ['id' => $stampCorrection->attendance_id]) }}">詳細</a>
                </div>
            </div>
            @endforeach
        </div>
